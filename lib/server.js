...
function default_1(htmxx) {
    ...
    htmxx.files.forEach(function (f) {
        ...
        getAppMethod(f.method, f.route, function (req, res) { return __awaiter(_this, void 0, void 0, function () {
            var _a, ws, markup_1, redirect;
            var _this = this;
            return __generator(this, function (_b) {
                switch (_b.label) {
                    case 0:
                        if (!(f.method === 'WS')) return [3 /*break*/, 1];
                        ...
                        return [3 /*break*/, 3];
                    case 1: return [4 /*yield*/, htmxx.processRoute(req.originalUrl.replace(/\?.+$/, ''), f.method, req)];
                    case 2:
                        _a = _b.sent(), ws = _a.ws, markup_1 = _a.markup, redirect = _a.redirect;
                        if (ws !== undefined) {
                            appWs.getWss().clients.forEach(function (client) {
                                if (client.OPEN) {
                                    client.send(markup_1);
                                }
                            });
                        }
                        res.send(markup_1);
