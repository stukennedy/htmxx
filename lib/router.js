...
function processPath(req, res, routes, route, doLayout) {
    return __awaiter(this, void 0, void 0, function* () {
        ...
        `;
            const script = new Function('params', 'body', 'query', 'redirect', functionText);
            ...
            const exe = yield script(req.params, req.body, req.query, res.redirect);
