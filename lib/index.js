...
var Htmxx = /** @class */ (function () {
    ...
    Htmxx.prototype.processRoute = function (route, method, req) {
        return __awaiter(this, void 0, void 0, function () {
            var file, error, errorRoute, output, error_1, errorRoute;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        file = this.files.find(function (file) { return file.routeRe.exec(route) && file.method === method; });
                        if (!(!file || file.hidden)) return [3 /*break*/, 2];
                        error = "".concat(method, ": route '").concat(route, "' not defined");
                        if (route === '/error') {
